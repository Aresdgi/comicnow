                                        ...
                                        <div class="flex-grow">
                                            <div class="flex justify-between items-start">
                                                ...
                                                <div class="flex space-x-1">
                                                    @for($i = 1; $i <= 5; $i++)
                                                        <svg class="w-5 h-5 {{ $i <= $resena->valoracion ? 'text-yellow-500' : 'text-gray-300' }}" 
                                            ...
                                            <div class="mt-2 flex space-x-3">
                                                <a href="{{ route('user.resenas.edit', $resena->id_resena) }}" class="text-blue-600 hover:text-blue-800">
                                                    Editar
                                                </a>
                                                <form action="{{ route('user.resenas.destroy', $resena->id_resena) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
