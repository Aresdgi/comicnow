...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Detalles del Cómic</h1>
        <div class="flex space-x-2">
            <a href="{{ route('admin.comics.edit', $comic->id_comic) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
                Editar
            </a>
        ...
        <div class="md:flex">
            ...
            <div class="md:w-1/3 p-6 border-r">
                ...
                <div class="mt-4 flex flex-col space-y-2">
                    <a href="{{ route('admin.comics.edit', $comic->id_comic) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded text-center">
                        Editar Cómic
                    </a>
                    ...
                    <a href="{{ asset('storage/' . $comic->archivo_comic) }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center">
                        Ver Archivo
                    </a>
                    @endif
                </div>
