...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <form action="{{ route('admin.autores.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="biografia" id="biografia" rows="5"
                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">{{ old('biografia') }}</textarea>
                    @error('biografia')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
